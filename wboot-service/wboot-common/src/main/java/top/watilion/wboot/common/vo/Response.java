...
public class Response<T> {
    ...
    public Response<T> result(ResultCode resultCode) {
        return result(resultCode.getCode(),false,resultCode.getMessage(),null,null);
    }
    ...
    public Response<T> duplicate(){
        return result(ResultCode.DUPLICATE.getCode(),ResultCode.DUPLICATE.isSuccess(),ResultCode.DUPLICATE.getMessage(),null,null);
    }

    public Response<T> duplicate(String message){
        return result(ResultCode.DUPLICATE.getCode(),ResultCode.DUPLICATE.isSuccess(),message,null,null);
    }

    public Response<T> duplicate(T data){
        return result(ResultCode.DUPLICATE.getCode(),ResultCode.DUPLICATE.isSuccess(),ResultCode.DUPLICATE.getMessage(),data,null);
    }

    public Response<T> duplicate(T data,String message){
        return result(ResultCode.DUPLICATE.getCode(),ResultCode.DUPLICATE.isSuccess(),message,data,null);
    }
}
